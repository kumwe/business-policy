 ...
 * missing is a broken consumer. The archive must carry docs/release-record.md because the consumer verification gate
...
$failures = [];
$expected = [];
foreach (['CHANGELOG.md', 'CHARTER.md', 'LICENSE', 'README.md', 'composer.json', 'docs/release-record.md'] as $file) {
